...
extern void aw2013_breath_led0(int led0);
extern void aw2013_breath_led1(int led1);
extern void aw2013_led_on(int led0, int led1, int led2);
extern void aw2013_led_led0(int led0);
extern void aw2013_led_led1(int led1);
...
int pmic_period_array[] = { 2, 4, 6, 8, 10, 12, 20, 60, 2500, 3000};
int pmic_freqsel_array[] = { 0, 1, 2, 3, 4, 5, 9, 28, 1249, 5000 };
...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
    ...
    if(pmic_freqsel_array[time_index] >1249)
            led_flag=1;
...
int mt_brightness_set_pmic(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	...
	if (pmic_type == MT65XX_LED_PMIC_NLED_ISINK0) {
                if (level)
                {
                    ...
                    {
                        aw2013_led_led1(0);
                        mt6357_upmu_set_chrind_en(0); //open pcharg 
                    }
                    else
                        mt6357_upmu_set_chrind_en(0); //open pcharg 
                }
                else
                {
                    ...
                    {
                        aw2013_led_led1(0);
                        mt6357_upmu_set_chrind_en(1);//close pcharg
                    }
                    else
                        mt6357_upmu_set_chrind_en(1);//close pcharg
                }
