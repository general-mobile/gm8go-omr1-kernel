	...
	enum IMGSENSOR_HW_PIN_STATE pin_state)
{
	...
	if (pregulator) {
       ...
       /* Vanzo:xingdongxiao on wed 9 may 17:30:00 +8000*/
          if (pin_state == IMGSENSOR_HW_PIN_STATE_LEVEL_2900) {
            pin_state  = IMGSENSOR_HW_PIN_STATE_LEVEL_2800;
            pmic_config_interface(0x1c8c, 10 ,0xf, 0);
          }
       // end of vanzo: xingdongxiao
