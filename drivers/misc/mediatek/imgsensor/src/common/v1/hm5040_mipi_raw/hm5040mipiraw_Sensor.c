...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.grabwindow_width  = 1288,		//record different mode's width of grabwindow
		.grabwindow_height = 970,		//record different mode's height of grabwindow
