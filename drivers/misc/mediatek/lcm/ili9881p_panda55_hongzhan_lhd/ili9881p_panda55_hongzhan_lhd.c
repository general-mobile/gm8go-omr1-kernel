...
static void lcm_get_params(LCM_PARAMS *params)
{
  ...
  params->dsi.PLL_CLOCK = 320;//258 ;//260;//212;//208;	
...
#if defined(BUILD_LK)
  printf("ili9881p_panda55_hongzhan_lhd%s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
  printk("ili9881p_panda55_hongzhan_lhd%s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
