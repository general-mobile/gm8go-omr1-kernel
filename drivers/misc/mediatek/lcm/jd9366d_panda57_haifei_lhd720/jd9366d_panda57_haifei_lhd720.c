...
static struct LCM_setting_table lcm_initialization_setting[] =
{
  ...
  {0xAC,1,{0x19}},// 
  {0xAD,1,{0x0E}},// 1/2VCOM FW
  {0xAE,1,{0x0E}},// 1/2VCOM BW
...
//  params->density = LCM_DENSITY;
  ...
  params->dsi.vertical_backporch					= 8 ; //20;  //16;
  params->dsi.vertical_frontporch					= 36;  //50; //200; //16;
  params->dsi.vertical_active_line				= FRAME_HEIGHT; 

  params->dsi.horizontal_sync_active				= 40; //40;
  params->dsi.horizontal_backporch				= 80; //100;60;
  params->dsi.horizontal_frontporch				= 80; //70;60;
...
#if defined(BUILD_LK)
  printf("%s,jd9366 id_high = 0x%08x,id = 0x%08x\n", __func__, id_high,id);
#else
  printk("%s,jd9366  id_high= 0x%08x,id = 0x%08x\n", __func__, id_high,id);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER jd9366d_panda57_haifei_lhd720_lcm_drv = 
{
  .name          = "jd9366d_panda57_haifei_lhd720",
