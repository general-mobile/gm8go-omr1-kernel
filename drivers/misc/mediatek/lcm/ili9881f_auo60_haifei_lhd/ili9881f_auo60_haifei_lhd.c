...
{
//20170818
//ILI9881F AUO X599 TEST 

{0xFF, 3, {0x98,0x81,0x02}},			//page2
{0x4D, 1, {0x0E}},				//turn off source precharge 0E 
...
{0x07, 1, {0x31}},				//bit6 TSXD gating, bit 0 tp term modulation enable
...
//SRC output, 0 gnd; 1 hi-z; 2 G0; 3 G255; 4 Last Data
...
{0xD0, 1, {0x13}},				//03 // 0x1x re-scan 2 line, 0x2x re-scan 1 line
//{0xD1, 1, {0x80}},
//{0xD2, 1, {0x80}},
//{0xD3, 1, {0x95}},
//{0xD4, 1, {0x91}},				//9C
...
{0x04, 1, {0x26}},				//VCOM	 45H 
{0x30, 1, {0x3D}},				//VCOM	  20180115
...
static void lcm_get_params(LCM_PARAMS *params)
{
  ...
  params->dsi.horizontal_backporch				= 35;//60
...
#if defined(BUILD_LK)
  printf("ili9881f_auo60_haifei_lhd %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
  printk("ili9881f_auo60_haifei_lhd %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
...
LCM_DRIVER ili9881f_auo60_haifei_lhd_lcm_drv =
{
  .name			= "ili9881f_auo60_haifei_lhd",
