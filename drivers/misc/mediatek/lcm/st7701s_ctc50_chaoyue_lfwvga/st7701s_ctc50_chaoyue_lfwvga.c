...
#if defined(BUILD_LK)
	printf("st7701_ctc50_chaoyue_fwvga  %s,line=%d, device_id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
	printk("st7701_ctc50_chaoyue_fwvga  %s,line=%d, device_id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
...
LCM_DRIVER st7701s_ctc50_chaoyue_lfwvga_lcm_drv =
{
  .name		  = "st7701s_ctc50_chaoyue_lfwvga",
