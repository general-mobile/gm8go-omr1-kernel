...
enum DEV_NAME_E {
    ...
    FP,
#endif
#ifdef VANZO_DUAL_CAM_NAME_SUPPORT
    CAM3,
#endif
    DEV_MAX_NUM
};
...
{
#if (defined VANZO_DUAL_CAM_NAME_SUPPORT) && (defined VANZO_FP_NAME_SUPPORT)
seq_printf(m, "Boardinfo:\nCPU:\t%s\nLCM:\t%s\nTP:\t%s\nCAM:\t%s\nCAM2:\t%s\nCAM3:\t%s\nFP:\t%s\n\n", \
        &v_dev_name[CPU][0], &v_dev_name[LCM][0], &v_dev_name[TP][0], &v_dev_name[CAM][0], &v_dev_name[CAM2][0],&v_dev_name[CAM3][0],&v_dev_name[FP][0]);

#elif VANZO_FP_NAME_SUPPORT
seq_printf(m, "Boardinfo:\nCPU:\t%s\nLCM:\t%s\nTP:\t%s\nCAM:\t%s\nCAM2:\t%s\nFP:\t%s\n\n", \
        &v_dev_name[CPU][0], &v_dev_name[LCM][0], &v_dev_name[TP][0], &v_dev_name[CAM][0], &v_dev_name[CAM2][0],&v_dev_name[FP][0]);
