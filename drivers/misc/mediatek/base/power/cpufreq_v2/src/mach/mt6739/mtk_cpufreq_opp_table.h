...
#define CPU_DVFS_FREQ0_LL_SB2		1690000		/* KHz */
#define CPU_DVFS_FREQ1_LL_SB2		1612000		/* KHz */
#define CPU_DVFS_FREQ2_LL_SB2		1391000		/* KHz */
#define CPU_DVFS_FREQ3_LL_SB2		1170000		/* KHz */
#define CPU_DVFS_FREQ4_LL_SB2		1105000		/* KHz */
#define CPU_DVFS_FREQ5_LL_SB2		1053000		/* KHz */
#define CPU_DVFS_FREQ6_LL_SB2		1001000		/* KHz */
#define CPU_DVFS_FREQ7_LL_SB2		962000		/* KHz */
#define CPU_DVFS_FREQ8_LL_SB2		910000		/* KHz */
#define CPU_DVFS_FREQ9_LL_SB2		845000		/* KHz */
#define CPU_DVFS_FREQ10_LL_SB2		 702000		/* KHz */
#define CPU_DVFS_FREQ11_LL_SB2		 624000		/* KHz */
#define CPU_DVFS_FREQ12_LL_SB2		 546000	/* KHz */
#define CPU_DVFS_FREQ13_LL_SB2		 416000	/* KHz */
#define CPU_DVFS_FREQ14_LL_SB2		 338000	/* KHz */
#define CPU_DVFS_FREQ15_LL_SB2		 299000	/* KHz */
...
#define CPU_DVFS_VOLT0_VPROC1_SB2	 130625		/* 10uV */
#define CPU_DVFS_VOLT1_VPROC1_SB2	 128750		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC1_SB2	 126875		/* 10uV */
#define CPU_DVFS_VOLT3_VPROC1_SB2	 125000		/* 10uV */
#define CPU_DVFS_VOLT4_VPROC1_SB2	 122500		/* 10uV */
#define CPU_DVFS_VOLT5_VPROC1_SB2	 120000		/* 10uV */
#define CPU_DVFS_VOLT6_VPROC1_SB2	 117500		/* 10uV */
#define CPU_DVFS_VOLT7_VPROC1_SB2	 115625		/* 10uV */
#define CPU_DVFS_VOLT8_VPROC1_SB2	 113750		/* 10uV */
#define CPU_DVFS_VOLT9_VPROC1_SB2	 111875		/* 10uV */
#define CPU_DVFS_VOLT10_VPROC1_SB2	 107500		/* 10uV */
#define CPU_DVFS_VOLT11_VPROC1_SB2	 105000		/* 10uV */
#define CPU_DVFS_VOLT12_VPROC1_SB2	 102500		/* 10uV */
#define CPU_DVFS_VOLT13_VPROC1_SB2	 100000		/* 10uV */
#define CPU_DVFS_VOLT14_VPROC1_SB2	 97500		/* 10uV */
#define CPU_DVFS_VOLT15_VPROC1_SB2	 95000		/* 10uV */
...
static struct mt_cpu_freq_method opp_tbl_method_LL_e2[] = {	/* FY2 */
	/* POS,	CLK */
	FP(1,	1),
	FP(1,	1),
	FP(1,	1),
...
static struct mt_cpu_freq_method opp_tbl_method_LL_e3[] = {	/* SB2 */
	/* POS,	CLK */
	FP(1,	1),
	FP(1,	1),
	FP(1,	1),
