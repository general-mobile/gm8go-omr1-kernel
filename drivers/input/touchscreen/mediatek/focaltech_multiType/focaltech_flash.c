...
struct upgrade_func *upgrade_func_list[] = {
#if (defined(CONFIG_FTS_CHIP_TYPE_FT6336G) || defined(CONFIG_FTS_CHIP_TYPE_FT6336U))
    ...
    &upgrade_func_ft8607,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT8716)
    &upgrade_func_ft8716,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT8719)
    &upgrade_func_ft8719,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT8736)
    &upgrade_func_ft8736,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT5822)
    &upgrade_func_ft5822,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT5X46)
    &upgrade_func_ft5x46,
#elif defined(CONFIG_FTS_CHIP_TYPE_FT8006)
    &upgrade_func_ft8006,
